...
export class Navbar extends React.Component<Navbar.Props, Navbar.State> {
  ...
  render() {
    ...
    return (
      <div
        className={`${style['g-wrapper']} ${style['page-edit']} ${
      ...
      >
        <div className={style['g-sidebar']}>
          ...
          <ul
            className={`${style.vertical} ${style.menu} ${
          ...
          >
            ...
            >
              <a className={style['accordion-title']} href='#'>
                <i
                  className={`${style.icon} ${style['i-user']} ${
                    style['margin-right']
                  }`}
                />
                <span>Employees</span>
              ...
              <ul className={`${style.menu} ${style.vertical} ${style.nested}`}>
                <li className='active'>
                  <a href='#' onClick={this.goToEmployees}>
                    <i
                      className={`${style.icon} ${style['i-list']} ${
                        style['margin-right']
                      }`}
                    />
                ...
                <li>
                  <a href='#' onClick={this.goToAddEmployee}>
                    <i
                      className={`${style.icon} ${style['i-plus']} ${
                        style['margin-right']
                      }`}
                    />
                    <span>Add New</span>
